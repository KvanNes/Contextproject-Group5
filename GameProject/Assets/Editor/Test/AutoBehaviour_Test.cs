...
public class AutoBehaviourTest
{
    ...
    */
    ...
    public void Test_requestInitialPositions()
    {
        ...
        {
            NetworkView.Verify(net => net.RPC(It.IsAny<string>(), It.IsAny<NetworkPlayer>(), It.IsAny<Vector3>(), It.IsAny<float>(), It.IsAny<int>()));
            NetworkView.Verify(net => net.RPC(It.IsAny<string>(), It.IsAny<NetworkPlayer>(), It.IsAny<Quaternion>(), It.IsAny<int>()));
        }
    }
