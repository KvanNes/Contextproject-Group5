...
namespace GraphicalUI {
    public class GraphicalUIController : MonoBehaviour {
		...
		public static readonly PartsConfiguration DriverConfiguration = new PartsConfiguration(new DriverPart(), new RestartButtonPart(), new SignControllerDriver(), new FinishedPart(), new TimerPart(), new CountDownPart());
		public static readonly PartsConfiguration ThrottlerConfiguration = new PartsConfiguration(new ThrottlerPart(), new RestartButtonPart(), new SignControllerThrottler(), new FinishedPart(), new TimerPart(), new CountDownPart());
